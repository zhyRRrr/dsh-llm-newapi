    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "newapi-catalog", "aria-label": t("models"), children: [
      ...
      models.map((model, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-entry", children: [
        ...
        expanded.has(index) ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-modeladvanced", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "newapi-modelfield", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "newapi-modelfield-label", children: t("modelVision") }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "newapi-vision-toggle", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "input",
                {
                  type: "checkbox",
                  ...
                  onChange: (event) => {
                    patch(index, { input: event.target.checked ? ["text", "image"] : void 0 });
                  }
                }
              ),
              t("modelVisionHint")
...
var en = {
  ...
  modelVision: "Image (vision)",
  modelVisionHint: "Allow the model to receive image attachments directly",
