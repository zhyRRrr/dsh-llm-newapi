...
var NewApiAdapter = class extends LlmAdapter {
  ...
  async *request(options, signal, connection, apiKey, onComment) {
    const body = connection.protocol === "responses" ? serializeResponsesRequest(options) : connection.protocol === "anthropic-messages" ? serializeAnthropicRequest(options) : serializeRequest(options);
